...
import { X, Compass, Calendar, Users, MapPin, CheckCircle, Sparkles, Heart } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6" id="travel-modal-overlay">
      ...
      <motion.div 
        ...
        className="relative w-full max-w-xl bg-neutral-950 border border-white/20 rounded-2xl p-6 sm:p-8 text-white shadow-2xl z-10"
      ...
      >
        ...
        {isSubmitted ? (
          <div className="py-12 flex flex-col items-center text-center">
            ...
            <h3 className="text-2xl font-bold mb-2">Your Journey Has Begun</h3>
            <p className="text-neutral-400 max-w-sm text-sm">
              Our Tripzy travel curator is preparing your bespoke escape to {destination}. We'll reach out shortly with handpicked stays and authentic local discoveries.
            </p>
          </div>
        ) : (
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs uppercase tracking-[0.2em] text-neutral-400">Tripzy Travel Curator</span>
            </div>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-2">Start Your Travel Journey</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full bg-neutral-900 border border-white/20 rounded-lg px-3.5 py-2.5 text-sm text-white focus:outline-none focus:border-white transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-neutral-900 border border-white/20 rounded-lg px-3.5 py-2 text-xs sm:text-sm text-white focus:outline-none focus:border-white transition-colors resize-none"
                />
              </div>
              ...
              <div className="pt-2">
                <button
                  type="submit"
                  className="w-full bg-white text-black font-semibold py-3 rounded-full hover:bg-neutral-200 transition-colors flex items-center justify-center gap-2 cursor-pointer shadow-md"
                >
