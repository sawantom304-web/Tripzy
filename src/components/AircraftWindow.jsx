...
export function AircraftWindow({ onBookClick }) {
  const [shadePosition, setShadePosition] = useState(0); // 0 = fully open, 100 = fully closed
  ...
  return (
    <div className="relative flex flex-col items-center select-none" id="aircraft-window-container">
      ...
      {/* "Start Travel Journey" Pill Button */}
      <div className="relative -mt-6 sm:-mt-7 z-30 flex items-center justify-center">
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="group relative flex items-center gap-2 sm:gap-2.5 bg-[#00F5D4] text-black font-syne font-bold text-xs sm:text-sm pl-5 pr-2 py-2 sm:py-2.5 rounded-full shadow-[0_12px_30px_rgba(0,245,212,0.4)] hover:shadow-[0_15px_35px_rgba(0,245,212,0.6)] transition-all cursor-pointer glow-teal"
        >
          <span className="font-bold text-black tracking-tight">🚀 Start Travel Journey</span>
